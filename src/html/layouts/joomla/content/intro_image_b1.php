...
<?php if (isset($images->image_intro) && !empty($images->image_intro)) : ?>
	...
	<figure class="pull-<?php echo htmlspecialchars($imgfloat, ENT_COMPAT, 'UTF-8'); ?> lenta__image">
		<img
		...
		<?php if ($images->image_intro_caption) : ?>
		<figcaption><?php echo htmlspecialchars($images->image_intro_caption, ENT_COMPAT, 'UTF-8'); ?></figcaption>
		<?php endif; ?>
	</figure>
<?php endif; ?>
